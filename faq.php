...
<?php require_once("includes/navbar.php") ?>
    <section class="faq-container">
      ...
      <article class="qa">
        <strong class="picto">No encuentro mi problema</strong>
        <br><br>
